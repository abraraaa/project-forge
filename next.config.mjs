...
const nextConfig = {
  ...
  // objects) where manual memoisation is patchy. babel-plugin-react-compiler
  // MUST stay in devDependencies: Next loads it from node_modules and the
  // build fails without it (removed once in #256, restored in 249f2f3).
  //
  // SPIKE STATUS: additive + reversible. If it
