      ...
      <Fade d={120}>
        ...
        <div style={{position:"relative"}}>
          ...
          <div id="name-status" role="status" aria-live="polite"
            style={{marginTop:10,minHeight:16,fontSize:11,fontFamily:T.sans,color:pip?.colour || T.text3,display:"flex",alignItems:"center",gap:6,transition:`color 180ms ${T.ease}`}}>
            {submitError ? (
              ...
              // no stated reason.
              <span style={{color:T.text3}}>A bit more — names need 2 characters or more.</span>
            ) : (
              <span style={{color:T.text4}}>2 characters or more, no slashes. Case doesn&apos;t matter.</span>
            )}
          </div>
