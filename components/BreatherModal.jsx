  ...
  return (
    <div onKeyDown={onKeyDown} onClick={onCancel} className="forge-scrim"
      ...
      <div ref={containerRef} role="dialog" aria-modal="true" aria-labelledby={titleId} tabIndex={-1}
        ...
        style={{ background: T.bg2, borderRadius: `${T.r.lg}px ${T.r.lg}px 0 0`, padding: "28px 24px 32px", width: "100%", maxWidth: 430, borderTop: `1px solid ${T.bg3}`, animation: `slideUp 280ms ${T.ease}`, outline: "none" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 26 }}>
          {REASONS.map((r) => {
            ...
            return (
              <button key={r.id} onClick={() => setReason(on ? null : r.id)}
