...
//
// THE NEVER-LIST: no all-caps letterspaced
// microlabels · no italic-serif mood fragments · no pills · no glass or
// backdrop-filter · no grain overlays over content · no bevels · no glows,
// with ONE amendment (2026-08-30): .forge-lift, a press-only light under the
// thumb on commit surfaces, derived from --commit and off the heat ramp.
// Never on a sheet. Nothing else lights up — .forge-tint (2026-09-25) only
// warms the quiet press toward the thumb, a step off --press, never light ·
