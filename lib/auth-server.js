 ...
 * @param {{ profile: string, ttlMs: number, scope?: string | null, authAt?: string | null, credentialId?: string | null }} opts
 */
export async function mintAuthToken({ profile, ttlMs, scope = null, authAt = null, credentialId = null }) {
