  ...
  // ── C · Friday · Power + Volume ───────────────────────────────────────────
  {
    ...
    blocks:[
      ...
      { id:"css1",type:"superset",  label:"Superset · 1 of 3",   sets:3, rest:90,
        ...
        exB:{ name:"Cable Pull-Through",      reps:12,     weight:28,  muscle:"Glutes / Hams",     vid:"yXopOhzEoeo", loadType:"total" }},
...
export const EXERCISE_POOLS = {
  ...
  "css1-B":{ gripDemand:"NONE", zone:"cable",      pool:[
    { name:"Cable Pull-Through",           reps:12, weight:28, muscle:"Glutes / Hams",   vid:"yXopOhzEoeo", loadType:"total" },
    { name:"Cable Kickback",               reps:12, weight:12, muscle:"Glutes",           vid:"5jJNfIlKTmg", loadType:"total" },
    { name:"Glute Bridge",                 reps:15, weight:null,muscle:"Glutes",          vid:"wPM8icPu6H8", loadType:"bodyweight" },
    { name:"Cable Hip Abduction",          reps:12, weight:12, muscle:"Glutes",           vid:"pvnR8CDb4BU", loadType:"total" },
    { name:"Standing Cable Hip Extension", reps:12, weight:16, muscle:"Glutes / Hams",   vid:"xpcp_BfeWks", loadType:"total" },
    { name:"Banded Glute Bridge",          reps:15, weight:null,muscle:"Glutes",          vid:"GjLPEfu5PN0", loadType:"bodyweight" },
  ]},
