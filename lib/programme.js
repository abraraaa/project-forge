...
export const FOCUS_SUMMARIES = {
  Forged: "Balanced strength + conditioning. The default Heatwayve programme.",
...
export const CARDIO_BONUS_POOL = [
  ...
  { name: "Row Sprint",         detail: "5 × 150m. All out, full recovery.", vid: "zQ82R0-F2_o" },
  { name: "Wall Balls",         detail: "3 × 15. Full squat, hit the target.", vid: "Eq6w3X_uWz0" },
  { name: "Burpee Ladder",      detail: "1-2-3…up to 5, then back down.", vid: "hxc7t-dVY3I" },
  ...
  { name: "Shuttle Runs",       detail: "6 × 20m. Touch the line, turn hard.", vid: "7C_aC6Lz6kM" },
  ...
  { name: "Devil's Press",      detail: "3 × 8. Burpee into a double-DB snatch.", vid: "-C1iixGN9M8" },
];
...
export const SWAP_DB = {
  ...
  "DB Overhead Extension": [{ name:"Cable Overhead Extension"        , eq:"Cable"      , muscle:"Triceps"                   , vid:"GzmlxvSFE7A" },
                             { name:"Skullcrusher"                    , eq:"Barbell"    , muscle:"Triceps"                   , vid:"OQ4TWXkZjTc" }],
  "DB Reverse Lunge": [{ name:"Reverse Lunge"                   , eq:"Bodyweight" , muscle:"Quads & Glutes"            , vid:"D0-GqeDM3zc" },
                        { name:"Split Squat"                     , eq:"Bodyweight" , muscle:"Quads & Glutes"            , vid:"SGHnCki0x5I" }],
