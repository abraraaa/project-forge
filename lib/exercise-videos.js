...
/**
 * Names whose programme-entry footage is known bad — dead ids (2026-08-06
 * census: 10 of 160 were 404ing in production) or a wrong-movement demo
 * (Sumo Deadlift's id plays the Sumo Deadlift HIGH PULL — teaching a
 * different lift is worse than teaching nothing). Suppressed until verified
 * replacement footage lands; the empty state is the honest fallback.
 * 8 of the original 10 replaced 2026-08-12 (boss's own playlist finds,
 * oEmbed-verified 8/8) — only the two genuinely hard-to-source names remain.
 * @type {Set<string>}
 */
export const DEAD_UNTIL_REPLACED = new Set([
  "Wall Sit", "Y-T-W Raise",
  "Sumo Deadlift",   // wrong movement, not dead
]);
