...
export const MUSCLES = {
  ...
  CALVES: "Calves",
  CHEST: "Chest",
  // Back split 2026-07-13 (stage 3, panel-adjudicated landmarks): Lats and
  // Upper Back are banded hypertrophy targets; Erectors is a FATIGUE
  // CEILING like Traps/Core (mev 0) — tracked to warn when a mesocycle is
  // axially top-heavy, never to nag a shortfall. The Back key is RETIRED:
  // nothing may reference it (invariant-tested).
  LATS: "Lats",
  UPPER_BACK: "Upper Back",
  ERECTORS: "Erectors",
  // Traps were the recorded taxonomy gap (verified 2026-07-08): shrug/carry/
  // clean trap work leaked into Back. Own key so volume lands where it's
  // earned; landmarks live in volume-audit.js (mev 0 — traps are mostly
  // indirect volume, the row should flag excess, never nag a shortfall).
  TRAPS: "Traps",
...
export const PATTERN_DEFAULTS = {
  ...
  hinge: {
    primary: "Hamstrings",
    secondary: { Glutes: 0.6, Erectors: 0.35, Core: 0.3, Forearms: 0.25 },
  },
  lunge: {
    primary: "Quads",
  ...
  row: {
    primary: "Lats",
    secondary: { "Upper Back": 0.45, Biceps: 0.4, "Rear Delts": 0.3, Forearms: 0.2 },
  },
  pulldown: {
    primary: "Lats",
    secondary: { "Upper Back": 0.3, Biceps: 0.4, "Rear Delts": 0.2 },
  },
  pullup: {
    primary: "Lats",
    secondary: { "Upper Back": 0.3, Biceps: 0.5, "Rear Delts": 0.2, Core: 0.2, Forearms: 0.2 },
  },
  curl: {
    primary: "Biceps",
  ...
  power: {
    ...
    primary: "Hamstrings",
    secondary: { Glutes: 0.6, Erectors: 0.2, "Upper Back": 0.1, Traps: 0.2, Quads: 0.3, "Front Delts": 0.25, Calves: 0.25, Forearms: 0.35, Core: 0.4 },
  },
  carry: {
    // Loaded carries are isometric trap work first (the bar hangs off them
    // the whole walk) — the old Back 0.3 was the taxonomy-gap leak.
    primary: "Forearms",
    secondary: { Core: 0.5, Traps: 0.4, Erectors: 0.15, "Side Delts": 0.2 },
  },
  shrug: {
    primary: "Traps",
    secondary: { Forearms: 0.25, "Upper Back": 0.1 },
  },
};
...
export const EXERCISE_ANATOMY = {
  ...
  "Chest-Supported DB Row": {
    primary: "Upper Back",
    secondary: { Biceps: 0.4, "Rear Delts": 0.35, Traps: 0.25, Forearms: 0.2, Lats: 0.4 },
  },
  ...
  "Hex Bar Deadlift": {
    primary: "Quads",
    secondary: { Glutes: 0.6, Hamstrings: 0.5, Traps: 0.15, Forearms: 0.35, Core: 0.35, Calves: 0.1, Erectors: 0.3 },
  },
  ...
  "Pull-Up": {
    primary: "Lats",
    secondary: { Biceps: 0.45, "Rear Delts": 0.2, Core: 0.3, Forearms: 0.35, "Upper Back": 0.3 },
  },
  ...
  "Power Clean": {
    primary: "Hamstrings",
    secondary: { Glutes: 0.6, Traps: 0.3, Quads: 0.3, "Front Delts": 0.25, Calves: 0.25, Forearms: 0.35, Core: 0.4, Erectors: 0.2, "Upper Back": 0.1 },
  },
  "DB Walking Lunge": {
    primary: "Quads",
  ...
  "Cable Pull-Through": {
    primary: "Glutes",
    secondary: { Hamstrings: 0.45, Core: 0.2, Erectors: 0.15 },
  },
  ...
  // Incline BB Press: barbell incline, same emphasis as the DB version. It is
  // a Bench swap (MAIN_LIFT_FUNCTIONAL_EQUIVALENTS), so it MUST resolve to the
  // canonical muscles — without an entry it fell back to its "Upper chest"
  // label, which is outside the volume vocabulary, silently dropping 3 weekly
  // Chest sets from the audit and the solver whenever a user swapped to it.
  "Incline BB Press": {
    primary: "Chest",
    secondary: { "Front Delts": 0.45, Triceps: 0.3 },
  },
  ...
  "Seated Cable Row": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.25, Traps: 0.15, Core: 0.15, Forearms: 0.2, "Upper Back": 0.45 },
  },
  "DB Curl": {
    primary: "Biceps",
    secondary: { Forearms: 0.3 },
  ...
  // Weighted Dips: a Bench swap, so forward-lean chest-emphasis form (the
  // opposite of the upright "Tricep Dips" above) — Chest-primary so it counts
  // as a pressing alternative. Without this entry it fell back to its "Chest /
  // Triceps" label and dropped out of the volume vocabulary (same class as
  // Incline BB Press above).
  "Weighted Dips": {
    primary: "Chest",
  ...
  "Face Pull": {
    primary: "Rear Delts",
    secondary: { Traps: 0.15, Biceps: 0.2, "Side Delts": 0.15, "Upper Back": 0.2 },
  },
  ...
  // Front Squat: read against Barbell Back Squat, which it stands in for as a
  // main lift. Glutes hold near parity — EMG finds no meaningful gluteus
  // maximus difference between the two. What the front rack changes is the
  // torso: upright, so a shorter hip moment and less hamstring, and a real
  // isometric demand on the upper back and anterior core to keep the bar up.
  "Front Squat": {
    primary: "Quads",
    secondary: { Glutes: 0.45, Core: 0.4, "Upper Back": 0.3, Hamstrings: 0.2, Calves: 0.15 },
  },
  "Goblet Squat": {
    primary: "Quads",
  ...
  "Romanian Deadlift": {
    primary: "Hamstrings",
    secondary: { Glutes: 0.6, Core: 0.3, Forearms: 0.25, Erectors: 0.35 },
  },
  "Sumo Deadlift": {
    primary: "Quads",
    secondary: { Glutes: 0.6, Hamstrings: 0.4, Core: 0.35, Forearms: 0.3, Erectors: 0.4 },
  },
  "Dumbbell Deadlift": {
    primary: "Hamstrings",
    secondary: { Glutes: 0.6, Quads: 0.3, Core: 0.3, Forearms: 0.25, Erectors: 0.35 },
  },
  "Good Morning": {
    primary: "Hamstrings",
    secondary: { Glutes: 0.55, Core: 0.35, Erectors: 0.4 },
  },
  "Kettlebell Swing": {
    primary: "Glutes",
    secondary: { Hamstrings: 0.5, Core: 0.35, "Front Delts": 0.15, Erectors: 0.3 },
  },
  ...
  "Single-Leg RDL": {
    primary: "Hamstrings",
    secondary: { Glutes: 0.5, Core: 0.25, Forearms: 0.15, Erectors: 0.15 },
  },
  ...
  "45-Degree Hip Extension": {
    primary: "Glutes",
    secondary: { Hamstrings: 0.4, Erectors: 0.35 },
  },
  ...
  "Reverse Hyperextension": {
    primary: "Glutes",
    secondary: { Hamstrings: 0.35, Erectors: 0.3 },
  },
  ...
  "Landmine Squeeze Press": {
    primary: "Front Delts",
    secondary: { Chest: 0.5, Triceps: 0.25, Core: 0.2 },
  },
  "Svend Press": {
    primary: "Front Delts",
    secondary: { Chest: 0.5 },
  ...
  "Chin-Up": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.15, Core: 0.25, Forearms: 0.3, "Upper Back": 0.3 },
  },
  "Assisted Pull-Up": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.2, Core: 0.2, Forearms: 0.25, "Upper Back": 0.3 },
  },
  "Weighted Pull-Up": {
    primary: "Lats",
    secondary: { Biceps: 0.45, "Rear Delts": 0.2, Core: 0.35, Forearms: 0.4, "Upper Back": 0.3 },
  },
  "Wide-Grip Pull-Up": {
    primary: "Lats",
    secondary: { Biceps: 0.35, "Rear Delts": 0.25, Core: 0.3, Forearms: 0.35, "Upper Back": 0.3 },
  },
  "Neutral-Grip Pull-Up": {
    primary: "Lats",
    secondary: { Biceps: 0.5, "Rear Delts": 0.2, Core: 0.25, Forearms: 0.35, "Upper Back": 0.3 },
  },

  // ── Pulldown Variations ───────────────────────────────────────────────────
  "Lat Pulldown": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.2, Forearms: 0.2, "Upper Back": 0.3 },
  },
  "Cable Straight-Arm Pulldown": {
    primary: "Lats",
    secondary: { Triceps: 0.2, Core: 0.15, "Upper Back": 0.3 },
  },
  "Resistance Band Pull-Down": {
    primary: "Lats",
    secondary: { Biceps: 0.35, "Rear Delts": 0.2, "Upper Back": 0.3 },
  },

  // ── Row Variations ────────────────────────────────────────────────────────
  "Cable Row": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.25, Traps: 0.25, Core: 0.15, Forearms: 0.2, "Upper Back": 0.45 },
  },
  "Single-Arm Cable Row": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.25, Traps: 0.2, Core: 0.3, Forearms: 0.2, "Upper Back": 0.45 },
  },
  "Single-Arm DB Row": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.3, Traps: 0.2, Core: 0.25, Forearms: 0.25, "Upper Back": 0.45 },
  },
  "Dumbbell Bent-Over Row": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.3, Traps: 0.25, Core: 0.2, Forearms: 0.25, "Upper Back": 0.45 },
  },
  "Incline DB Row": {
    primary: "Upper Back",
    secondary: { Biceps: 0.4, "Rear Delts": 0.35, Traps: 0.25, Forearms: 0.2, Lats: 0.4 },
  ...
  "Seal Row": {
    primary: "Upper Back",
    secondary: { Biceps: 0.4, "Rear Delts": 0.35, Traps: 0.3, Forearms: 0.2, Lats: 0.4 },
  },
  "Meadows Row": {
    primary: "Lats",
    secondary: { Biceps: 0.35, "Rear Delts": 0.35, Traps: 0.2, Core: 0.25, Forearms: 0.25, "Upper Back": 0.45 },
  },
  "Wide-Grip Cable Row": {
    primary: "Upper Back",
    secondary: { Biceps: 0.3, "Rear Delts": 0.35, Traps: 0.3, Core: 0.15, Forearms: 0.2, Lats: 0.4 },
  },
  "Half-Kneeling Cable Row": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.25, Traps: 0.2, Core: 0.35, Forearms: 0.2, "Upper Back": 0.45 },
  },
  "Face-Away Cable Row": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.3, Traps: 0.25, Core: 0.3, Forearms: 0.2, "Upper Back": 0.45 },
  },
  "TRX Row": {
    primary: "Lats",
    secondary: { Biceps: 0.4, "Rear Delts": 0.25, Traps: 0.2, Core: 0.35, Forearms: 0.2, "Upper Back": 0.45 },
  ...
  "Resistance Band Row": {
    primary: "Lats",
    secondary: { Biceps: 0.35, "Rear Delts": 0.25, Traps: 0.2, Forearms: 0.15, "Upper Back": 0.45 },
  },
  ...
  "Y-T-W Raise": {
    primary: "Rear Delts",
    secondary: { "Side Delts": 0.3, "Upper Back": 0.25 },
  },
  "Prone Y Raise": {
    primary: "Traps",
    secondary: { "Rear Delts": 0.5, "Side Delts": 0.2 },
  },

  // ── Rear Delt Variations ──────────────────────────────────────────────────
  "Rear Delt Fly": {
    primary: "Rear Delts",
    secondary: { "Upper Back": 0.25 },
  },
  "Cable Rear Delt Fly": {
    primary: "Rear Delts",
    secondary: { "Upper Back": 0.25 },
  ...
  "Band Face Pull": {
    primary: "Rear Delts",
    secondary: { Traps: 0.15, Biceps: 0.15, "Side Delts": 0.15, "Upper Back": 0.2 },
  },
  "Band Pull-Apart": {
    primary: "Rear Delts",
    secondary: { Traps: 0.25, "Side Delts": 0.15, "Upper Back": 0.05 },
  },
  ...
  "Ab Wheel": {
    primary: "Core",
    secondary: { "Front Delts": 0.15, Lats: 0.2 },
  },
  "Stir the Pot": {
    primary: "Core",
    secondary: { Glutes: 0.15, "Front Delts": 0.1 },
  ...
  "Bird Dog": {
    primary: "Core",
    secondary: { Glutes: 0.2, Erectors: 0.15 },
  },
  "Reverse Crunch": {
    primary: "Core",
    secondary: {},
  ...
  "Toes-to-Bar": {
    primary: "Core",
    secondary: { Forearms: 0.3, Lats: 0.15 },
  },
  "Windshield Wiper": {
    primary: "Core",
    secondary: { Forearms: 0.2, Lats: 0.15 },
  },
  ...
  "Hang Power Clean": {
    primary: "Hamstrings",
    secondary: { Glutes: 0.6, Traps: 0.3, Quads: 0.25, "Front Delts": 0.25, Calves: 0.2, Forearms: 0.35, Core: 0.4, Erectors: 0.2, "Upper Back": 0.1 },
  },
  "Dumbbell Hang Clean": {
    primary: "Hamstrings",
    secondary: { Glutes: 0.55, Traps: 0.3, Quads: 0.25, "Front Delts": 0.2, Calves: 0.2, Forearms: 0.3, Core: 0.35, Erectors: 0.17, "Upper Back": 0.08 },
  },
  ...
  // ── Travel-mode movements (lib/travel.js) ─────────────────────────────────
  // Curated rather than left to resolveByPattern: travel sessions feed the
  // volume audit like any other, and "Chair Dip" pattern-matches to nothing
  // while "Sliding Fly" would inherit a cable-fly profile that understates
  // the anti-extension core cost of doing it on a towel. Same conservative
  // scale as everything above — a push-up is a bench press for the muscles
  // it trains, not for the load, and volume counts sets.
  "Deficit Push-Up": {
    primary: "Chest",
    secondary: { Triceps: 0.4, "Front Delts": 0.3, Core: 0.2 },
  },
  "Inverted Row": {
    primary: "Upper Back",
    secondary: { Lats: 0.45, Biceps: 0.4, "Rear Delts": 0.35, Forearms: 0.2, Core: 0.2 },
  },
  // Hamstring curl AND a held bridge — the glutes are working the whole set,
  // which a machine curl's profile doesn't capture.
  "Sliding Leg Curl": {
    primary: "Hamstrings",
    secondary: { Glutes: 0.4, Core: 0.3 },
  },
  "Bottle Lateral Raise": {
    primary: "Side Delts",
    secondary: { Traps: 0.2, "Front Delts": 0.15 },
  },
  "Walking Lunge": {
    primary: "Quads",
    secondary: { Glutes: 0.5, Hamstrings: 0.2, Calves: 0.2, Core: 0.25 },
  ...
  "Backpack Curl": {
    primary: "Biceps",
    secondary: { Forearms: 0.35 },
  },
  "Bodyweight Skullcrusher": {
    primary: "Triceps",
    secondary: { Core: 0.2, "Front Delts": 0.15 },
  },
  "Towel Face Pull": {
    primary: "Rear Delts",
    secondary: { Traps: 0.35, "Upper Back": 0.3, Biceps: 0.15 },
  },
  // The core weight is the honest part: holding a plank while the arms open
  // is most of why this is hard on a floor.
  "Sliding Fly": {
    primary: "Chest",
    secondary: { "Front Delts": 0.3, Core: 0.35, Biceps: 0.1 },
  },
  "Backpack Shrug": {
    primary: "Traps",
    secondary: { Forearms: 0.3 },
  },
  // Bench/chair dips sit between a triceps extension and a press — the
  // shoulder-extended position recruits front delt and lower chest properly.
  "Chair Dip": {
    primary: "Triceps",
    secondary: { "Front Delts": 0.35, Chest: 0.3 },
  },
  // Triple extension without a barbell: the calves matter here in a way they
  // don't in a squat, because the jump finishes through the ankle.
  "Broad Jump": {
    primary: "Quads",
    secondary: { Glutes: 0.55, Hamstrings: 0.35, Calves: 0.4, Core: 0.25 },
  },
  "Bar Hang": {
    primary: "Forearms",
    secondary: { Lats: 0.3, Traps: 0.25, Core: 0.15 },
  },
  // Core-primary despite the legs doing the moving — the demand is holding
  // the plank while the hips flex.
  "Mountain Climber": {
    primary: "Core",
    secondary: { "Front Delts": 0.25, Quads: 0.25, Chest: 0.15 },
  },
  "Burpee": {
    primary: "Quads",
    secondary: { Chest: 0.35, "Front Delts": 0.3, Triceps: 0.3, Core: 0.3, Calves: 0.25 },
  },
};
...
function resolveByPattern(name) {
  ...
  if (/shrug/.test(lower)) return PATTERN_DEFAULTS.shrug;
