...
// the tempo sourcing prompt (internal notes), then reviewed before ingestion.
...
export const EXERCISE_TEMPO = {
  ...
  "Front Squat": {
    tempo: "3-1-1-0",
    evidence: "derived",
    principle: "Same prescription as the back squat it stands in for; the front rack punishes a slow eccentric that loses position, which is exactly the control the tempo is buying.",
    note: "Elbows high the whole way; the bar drops the moment they do.",
    sources: [
      "schoenfeld2015",
      "wilk2021"
    ]
  ...
  "Incline BB Press": {
    tempo: "3-1-1-0",
    evidence: "derived",
    principle: "Incline barbell press with pause; upper chest emphasis and controlled tempo.",
    note: "Bench at 30–45°; bar to upper chest, pause before pressing.",
    sources: [
      "schoenfeld2015"
    ]
  },
  ...
  "Weighted Dips": {
    tempo: "3-0-2-0",
    evidence: "derived",
    principle: "Weighted chest dip with a forward lean; controlled eccentric under added load builds pressing strength as a bench alternative.",
    note: "Lean the torso forward for chest emphasis; add load via belt/vest, depth to shoulder comfort.",
    sources: [
      "wilk2021"
    ]
  },
...
,
  ...
  // All "derived": no study prescribes a tempo for a towel leg curl. Each is
  // reasoned from its movement class and the same two tempo reviews the rest
  // of the dataset leans on — which is exactly what the label claims, and why
  // it isn't "direct".
  "Deficit Push-Up": {
    tempo: "3-1-1-0",
    evidence: "derived",
    principle: "Horizontal press with an added stretch position; the deficit lengthens the eccentric, and Schoenfeld 2015 supports controlled lowering for hypertrophy at bodyweight loads.",
    note: "Hands on blocks so the chest passes below them; pause in the stretch, don't bounce.",
    sources: [
      "schoenfeld2015",
      "wilk2021"
    ]
  ...
  "Inverted Row": {
    tempo: "2-1-1-1",
    evidence: "derived",
    principle: "Horizontal pull with an end-range hold; the pause at the top is where scapular retraction actually earns the set when load is fixed.",
    note: "Table edge or bar; squeeze shoulder blades at the top, body straight throughout.",
    sources: [
      "wilk2021"
    ]
  },
  "Sliding Leg Curl": {
    tempo: "3-0-2-0",
    evidence: "derived",
    principle: "Hamstring curl under a bridge hold; the slow eccentric is the whole stimulus at bodyweight, per tempo-hypertrophy findings.",
    note: "Heels on a towel, hips up the whole set; extend slowly, curl back under control.",
    sources: [
      "schoenfeld2015",
      "wilk2021"
    ]
  ...
  "Bottle Lateral Raise": {
    tempo: "2-0-2-1",
    evidence: "derived",
    principle: "Light-load isolation depends on tempo rather than load; the top pause keeps the delt working where leverage is hardest.",
    note: "Filled bottles; lead with the elbows, stop at shoulder height, no swing.",
    sources: [
      "wilk2021"
    ]
  },
  "Walking Lunge": {
    tempo: "2-0-1-0",
    evidence: "derived",
    principle: "Alternating lunge pattern; controlled descent protects the knee and keeps tension on the working leg.",
    note: "Long stride, torso tall; drive through the front heel.",
    sources: [
      "schoenfeld2015"
    ]
  },
  "Backpack Curl": {
    tempo: "3-0-1-1",
    evidence: "derived",
    principle: "Elbow flexion with an improvised load; the long eccentric and top squeeze compensate for a load you cannot fine-tune.",
    note: "Load the pack with books; keep elbows pinned, squeeze at the top.",
    sources: [
      "wilk2021"
    ]
  },
  "Bodyweight Skullcrusher": {
    tempo: "3-0-1-0",
    evidence: "derived",
    principle: "Elbow extension against bodyweight at an angle; slow eccentric is the only way to progress once the angle is fixed.",
    note: "Hands on a table edge, body straight; lower the forehead to the edge, press back out.",
    sources: [
      "schoenfeld2015"
    ]
  },
  "Towel Face Pull": {
    tempo: "2-1-1-1",
    evidence: "derived",
    principle: "Rear-delt work is an end-range hold movement; the pause at full retraction is the point, not the pull.",
    note: "Towel round a door anchor; pull to the forehead, elbows high, hold a beat.",
    sources: [
      "wilk2021"
    ]
  },
  "Sliding Fly": {
    tempo: "4-0-2-0",
    evidence: "derived",
    principle: "Long eccentric under an anti-extension demand — the same profile as an ab-wheel rollout with the chest as the prime mover.",
    note: "Hands on towels, floor smooth; open only as far as you can close under control.",
    sources: [
      "schoenfeld2015",
      "wilk2021"
    ]
  ...
  "Backpack Shrug": {
    tempo: "2-0-1-1",
    evidence: "derived",
    principle: "Scapular elevation with a top squeeze; traps respond to the hold more than the range.",
    note: "Loaded pack held at the sides; shrug straight up, squeeze, no rolling.",
    sources: [
      "wilk2021"
    ]
  },
  "Chair Dip": {
    tempo: "3-0-1-0",
    evidence: "derived",
    principle: "Shoulder-extended press; controlled eccentric with the shoulder in a vulnerable position, depth limited by comfort.",
    note: "Hands on a chair edge; stop when the upper arm is parallel, no deeper.",
    sources: [
      "schoenfeld2015"
    ]
  },
  "Broad Jump": {
    tempo: "2-0-X-0",
    evidence: "derived",
    principle: "Power expression: the concentric is maximal-intent and explosive by definition; tempo prescription applies only to the loading phase.",
    note: "Low reps, full recovery between them. Land soft, reset every rep — this is not conditioning.",
    sources: [
      "wilk2021"
    ]
  },
  "Bar Hang": {
    tempo: null,
    evidence: "none",
    principle: "Isometric hold — prescribed by duration and grip quality, not rep tempo.",
    note: "Dead hang from the bar, shoulders active not slack. Time the set.",
    sources: [
      "isometric"
    ]
  },
  "Mountain Climber": {
    tempo: "1-0-1-0",
    evidence: "derived",
    principle: "Cyclical core movement held at plank; the demand is bracing under a fast alternating leg drive, so the tempo stays quick and even.",
    note: "Hips level, no piking; drive the knees, keep the shoulders stacked.",
    sources: [
      "wilk2021"
    ]
  },
  "Burpee": {
    tempo: "1-0-X-0",
    evidence: "derived",
    principle: "Full-body movement finishing in a jump; the concentric is explosive, the descent controlled enough to protect the shoulders.",
    note: "Chest to floor, then drive up and jump. Quality over speed once fatigue arrives.",
    sources: [
      "wilk2021"
    ]
  }
