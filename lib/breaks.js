...
// (Away) and the catch-all. Labels stay short, warm, non-clinical.
//
// "Away", not "Travelling" (renamed 2026-08-05): travel MODE now means
// training away from your gym, so "Travelling" as a rest reason read as
// the same word making two opposite claims. A breather is resting away;
// travel mode is training away. The stored id stays "travelling" —
// renaming ids orphans synced records; only the label moves.
export const REASONS = [
  { id: "travelling", label: "Away" },
