...
//              rhythm rests from here; activity BEFORE it (e.g. a retro
//              fill for last week) does not end it.
//   · reason   one of REASONS[].id, or null if the user declined to say.
//   · endedAt  ISO date of the first activity AFTER start, or null while
//              the breather is open.
//
 ...
 * @param {Array<{id?: string, start?: string, endedAt?: string|null}>} breaks
 */
 ...
 * is open and the activity falls strictly AFTER its start — a session
 * logged (live or retro) on any day past the confirmation day resumes the
 * rhythm. Same-day and earlier activity does not (you can retro-fill last
 * week without cancelling a breather you started today).
 */
