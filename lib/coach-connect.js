...
export const CONNECT_OPTIONS = [
  {
    ...
    steps: [
      "Claude opens with Heatwayve filled in. Leave the OAuth fields empty and tap Add.",
      "Tap Connect, then Face ID. You're in.",
    ],
  },
  {
    ...
    steps: [
      ...
      "Under Apps or Connectors, choose Create. Paste the link, pick OAuth, and leave any client ID or secret empty.",
      "Connect, then Face ID. You're in.",
    ],
  },
  {
    id: "gemini", label: "Gemini", action: "copy", cta: "Copy the link",
    steps: [
      "On gemini.google.com (the web app), open Settings, then Connected apps.",
      "Under Custom apps, choose Add a custom app and paste the link. Leave any client ID empty.",
      "Approve, then Face ID. It follows you into the Gemini app too.",
    ],
  },
  {
    id: "muse", label: "Meta Muse", action: "copy", cta: "Copy the link",
    steps: [
      "In Muse, add a connector and choose Custom.",
      "Paste the link, then sign in with Face ID. You're in.",
    ],
  },
  {
    ...
    steps: [
      ...
      "Paste the link and leave any client ID or secret empty. Face ID does the rest.",
    ],
  },
];
