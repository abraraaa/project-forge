...
// Passkey rpId migration. An rpId is fixed at credential creation and cannot
// be rewritten server-side, so clearing this is a RE-ENROLMENT, not a data
// migration. After the sunset a theforged.fit credential cannot complete a
// ceremony at all, so it stops being protection without anything being deleted.
