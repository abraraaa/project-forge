 ...
 * entries. Last: 2026-08-06, verified demo footage for three catalogue
 * names (lib/exercise-videos.js).
 */
export const LIBRARY_REVISED = "2026-08-06";
...
function buildVideoIndex() {
  ...
  const claim = (name, vid) => {
    if (name && typeof vid === "string" && /^[\w-]{11}$/.test(vid) && !vids[name]) vids[name] = vid;
  };
