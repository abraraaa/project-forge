...
export const PROFILE_SUFFIXES = new Set([
  ...
  // left at home.
  "travel",
  // Re-enrolment prompt (lib/passkey-upgrade.js). NOT "passkeyNudge" above:
  // that asks a profile with no passkey to add one.
  "passkeyUpgrade",
  // Chosen main lifts (lib/programme.js applyMainLiftsToSession) and their
  // per-lift sync stamps.
  "mainLifts", "mainLiftStamps",
  // Absence-nudge dismissal (storage.js AN): the start date of the absence
  // last waved away. Device-local.
  "absenceNudge",
]);
